...
public class SignatureConvert {
	 ...
	 * @param output
	 *            the destination stream for the image * @throws IOException if
	 *            a problem writing the signature
	 */
	public void generateSignature(String jsonEncoding, OutputStream output) throws IOException {
	 ...
	 */
	public List<List<Point>> extractSignature(String jsonEncoding) {
	 ...
	 */
	public byte[] redrawSignature(List<List<Point>> lines) throws IOException {
